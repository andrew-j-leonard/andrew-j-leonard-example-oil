---
title: "Wrangling Oil Production Data with R and API's"
...
## Intro
This R Markdown document is part of a series of other examples like this one.  The purpose of these examples is to demonstrate how to solve problems in data science and analytics engineering with R, Tableau, linear regression, and more.
...
If a variable name begins with a `.` this is simply to avoid conflicting names with [R keywords](https://rdrr.io/r/base/Reserved.html) or other variables.


# Overview

## Scenario
In both data science and analytics engineering, you will inevitably encounter [Application Programming Interfaces (APIs)](https://en.wikipedia.org/wiki/API).  If you're not familiar with APIs but would like to learn more about them, I would recommend starting your journey down that rabbit hole with [this post](https://www.redhat.com/en/topics/api/what-are-application-programming-interfaces) from [RedHat](https://www.redhat.com/en) :).

## Problem

### Get data from RESTful API
In both data science and analytics engineering, you will inevitably encounter [Application Programming Interfaces (APIs)](https://en.wikipedia.org/wiki/API) - whether that means requesting data from them or building them.  

### Draw it out - big picture
Here are some diagrams

### Draw it out - granular
Here are some more diagrams

# Solution

## The Goal
The goal of this exercise is to extract oil production data 
